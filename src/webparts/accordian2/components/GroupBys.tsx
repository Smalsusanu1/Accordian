...
<SmartFilter/>
            ...
            <li className="for-lis">
                                    <div style={{width:"2%"}} className="padLR">
                                        <div style={{width:"80%"}} >
                                            <a className="hreflink" ng-show="!expand_collapse" ng-click="filterExpanded(allFamilyStructureOfItem)" title="Tap to expand the childs">
                                                <img ng-show="ProfileItem.Portfolio_x0020_Type=='Service'" style={{width:"10px"}}  ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/Rightarrowicon-green.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/Rightarrowicon-green.png" className="ng-hide" data-themekey="#"/>
                                                <img  style={{width:"10px"}}  ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Event_Icons/Rightarrowicon-orange.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Event_Icons/Rightarrowicon-orange.png" className="ng-hide" data-themekey="#"/>
                                                <img  style={{width:"10px"}}  ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/24/right-list-icon.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/24/right-list-icon.png" className="" data-themekey="#"/>
                                            </a>
                                            <a className="hreflink ng-hide"  title="Tap to Shrink the childs">
                                                <img  style={{width:"10px"}}  ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/Downarrowicon-green.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/Downarrowicon-green.png" className="ng-hide" data-themekey="#"/>
                                                <img  style={{width:"10px"}}  ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Event_Icons/Downarrowicon-orange.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Event_Icons/Downarrowicon-orange.png" className="ng-hide" data-themekey="#"/>
                                                <img  style={{width:"10px"}}  ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/24/list-icon.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/24/list-icon.png" className="" data-themekey="#"/>
                                            </a>
                                            <a className="hreflink"  title="Tap to Collpase the childs">
                                                <img  style={{width:"10px"}}  ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/sub_icon.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/sub_icon.png" className="" data-themekey="#"/>
                                                <img  style={{width:"10px"}} ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/sub_icon.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/sub_icon.png" className="ng-hide" data-themekey="#"/>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{width:"30%"}} className="">
                                        <div style={{width:"99%"}}className="colm-relative">
                                            <input id="searchTitle" type="search" placeholder="Title" title="Title" className="full_width ng-pristine ng-untouched ng-valid ng-empty"/>
                                            <span className="searchclear-bg ng-hide">X</span>
                                            <span className="sortingfilter">
                                                <span className="ml0">
                                    ...
                                    <div style={{width:"7%"}} className="">
                                        <div style={{width:"82%"}} className="colm-relative">
                                            ...
                                            <span className="dropdown filer-icons">
                                                <span className="filter-iconfil"  ng-click="myFunction('myDropdown1','PercentComplete')">
                                    ...
                                    <div style={{width:"7%"}} className="">
                                        <div style={{width:"75%"}} className="colm-relative">
                                            <input id="searchItemRank" type="search" placeholder="ItemRank" title="ItemRank" className="full_width ng-pristine ng-untouched ng-valid ng-empty" ng-model=" globalItem.searchItemRank"/>
                                            <span className="searchclear-bg ng-hide">X</span>
                                            <span className="sortingfilter">
                                                <span className="ml0">
                                                    <i className="fa fa-angle-up hreflink " ></i>
                                            ...
                                            <span className="dropdown filer-icons">
                                                <span className="filter-iconfil"  ng-click="myFunction('myDropdown1','ItemRank')">
                                                    <i title="Site" className="fa fa-filter hreflink " ></i>
                                                    <i title="Site" className="fa fa-filter hreflink  glyphicon_active ng-hide" ></i>
                                                </span>
                                            </span>
                                    ...
                                    <div style={{width:"10%"}} className="">
                                        <div style={{width:"82%"}} className="colm-relative">
                                            <input id="searchTeamMember" type="search" placeholder="Team" title="Team" className="full_width ng-pristine ng-untouched ng-valid ng-empty" ng-model="globalItem.searchTeamMember"/>
                                            <span className="searchclear-bg ng-hide" ng-show="globalItem.searchTeamMember.length>0" ng-click="clearControl('searchTeamMember')">X</span>
                                            <span className="sortingfilter">
                                                <span className="ml0">
                                                    <i className="fa fa-angle-up hreflink " ng-click="sortBy('orderComponent','AllTeamName', false)"></i>
                                                </span>
                                                <span className="ml0">
                                                    <i className="fa fa-angle-down hreflink " ng-click="sortBy('orderComponent','AllTeamName', true)"></i>
                                                </span>
                                            </span>
                                            <span className="dropdown filer-icons">
                                                <span className="filter-iconfil"  ng-click="myFunction('myDropdown1','Team Members')">
                                                    <i title="Site" className="fa fa-filter hreflink " ng-show="ResponsibilityFilterGrey"></i>
                                                    <i title="Site" className="fa fa-filter hreflink  glyphicon_active ng-hide" ng-show="!ResponsibilityFilterGrey"></i>
                                                </span>
                                            </span>
                                        </div>
                                    ...
                                    <div style={{width:"9%"}} className="">
                                        <div style={{width:"82%"}} className=" colm-relative">
                                            <input id="searchEarliestDate" type="search" placeholder="Due Date" title="Due Date" className="full_width  ng-pristine ng-untouched ng-valid ng-empty" ng-model="globalItem.searchEarliestDate"/>
                                            <span className="searchclear-bg ng-hide" ng-show="globalItem.searchEarliestDate.length>0" ng-click="clearControl('searchEarliestDate')">X</span>
                                            <span className="sortingfilter">
                                                <span className="ml0">
                                                    <i className="fa fa-angle-up hreflink " ng-click="sortBy('orderComponent','NewestDueDate', false)"></i>
                                                </span>
                                                <span className="ml0">
                                                    <i className="fa fa-angle-down hreflink " ng-click="sortBy('orderComponent','NewestDueDate', true)"></i>
                                                </span>
                                            </span>
                                            <span className="dropdown filer-icons">
                                                <span className="filter-iconfil"  ng-click="myFunction('myDropdown1','NewestDueDate')">
                                                    <i title="Site" className="fa fa-filter hreflink " ng-show="DueDateFilterGrey"></i>
                                                    <i title="Site" className="fa fa-filter hreflink  glyphicon_active ng-hide" ng-show="!DueDateFilterGrey"></i>
                                                </span>
                                            </span>
                                        </div>
                                    ...
                                    <div style={{width:"9%"}} className="">
                                        <div style={{width:"86%"}} className="colm-relative">
                                            <input id="searchCreatedDate" type="search" placeholder="Created Date" title="Created Date" className="full_width ng-pristine ng-untouched ng-valid ng-empty" ng-model="globalItem.searchCreatedDate"/>
                                            <span className="searchclear-bg ng-hide" ng-show="globalItem.searchCreatedDate.length>0" ng-click="clearControl('searchCreatedDate')">X</span>
                                            <span className="sortingfilter">
                                                <span className="ml0">
                                                    <i className="fa fa-angle-up hreflink " ng-click="sortBy('orderComponent','CreatedDate', false)"></i>
                                                </span>
                                                <span className="ml0">
                                                    <i className="fa fa-angle-down hreflink " ng-click="sortBy('orderComponent','CreatedDate', true)"></i>
                                                </span>
                                            </span>
                                            <span className="dropdown filer-icons">
                                                <span className="filter-iconfil" ng-click="myFunction('myDropdown1','CreatedDate')">
                                                    <i title="Site" className="fa fa-filter hreflink " ng-show="CreatedDateFilterGrey"></i>
                                                    <i title="Site" className="fa fa-filter hreflink  glyphicon_active ng-hide" ng-show="!CreatedDateFilterGrey"></i>
                                                </span>
                                            </span>
                                        </div>
                                    ...
                                    <div style={{width:"7%"}} className="">
                                        <div style={{width:"73%"}} className="colm-relative">
                                            <input id="searchTime" type="search" placeholder="Smart Time" title="Smart Time" className="full_width ng-pristine ng-untouched ng-valid ng-empty" ng-model="globalItem.searchTime"/>
                                            <span className="searchclear-bg ng-hide" ng-show="globalItem.searchTime.length>0" ng-click="clearControl('searchTime')">X</span>
                                            <span className="sortingfilter">
                                                <span className="ml0">
                                                    <i className="fa fa-angle-up hreflink " ng-click="sortBy('orderComponent','Effort', false)"></i>
                                                </span>
                                                <span className="ml0">
                                                    <i className="fa fa-angle-down hreflink " ng-click="sortBy('orderComponent','Effort', true)"></i>
                                                </span>
                                            </span>
                                            <span className="dropdown filer-icons">
                                                <span className="filter-iconfil"  ng-click="myFunction('myDropdown1','SmartTime')">
                                                    <i title="Site" className="fa fa-filter hreflink " ng-show="SmartTimeFilterGrey"></i>
                                                    <i title="Site" className="fa fa-filter hreflink  glyphicon_active ng-hide" ng-show="!SmartTimeFilterGrey"></i>
                                                </span>
                                            </span>
                                        </div>
                                    ...
                                    <div style={{width:"2%"}} className="padLR mt-5">
                                        <a className="hreflink ng-hide" title="Restructuring Tool" data-toggle="modal" ng-show="IsRestructureActive" target="_blank" ng-click="openRestructuringPopup()">
                                            <img className="icon-sites-img ng-hide" ng-show="ProfileItem.Portfolio_x0020_Type =='Service'" ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/Restructuring_Tool.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Service_Icons/Restructuring_Tool.png" data-themekey="#"/>
                                            <img className="icon-sites-img ng-hide" ng-show="ProfileItem.Portfolio_x0020_Type =='Events'" ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Event_Icons/Restructuring_Tool.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Event_Icons/Restructuring_Tool.png" data-themekey="#"/>
                                            <img className="icon-sites-img" ng-show="ProfileItem.Portfolio_x0020_Type =='Component'" ng-src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/Restructuring_Tool.png" src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/Restructuring_Tool.png" data-themekey="#"/>
                                        </a>
                                    </div>
                                    <div style={{width:"2%"}} className="padLR">
                                        <div style={{width:"80%"}}>
                                                        ...
                                                        <tr>
                                                            <td className="pad0" colSpan={9}>
                                                                <table style={{ width: "100%" }}>
                                                                    <tr className={isActive ? 'for-lis bold tdrows project_active' : ''}>
                                                                        ...
                                                                        <td style={{ width: "20%" }}>
                                                                            ...
                                                                            {item.Child.Short_x0020_Description_x0020_On != null &&
                                                                                    ...
                                                                                    src="https://hhhhteams.sharepoint.com/sites/HHHH/SP/SiteCollectionImages/ICONS/24/infoIcon.png" /><span className="tooltipte">
                                                                                        <span className="tooltiptext">
                                                                                            <div className="tooltip_Desc">
                                                                                                <span>{item.Child.Short_x0020_Description_x0020_On}</span>
                                                                                            </div>
                                                                                        </span>
                                                                                    </span>
                                                                                </span>
                                                                        ...
                                                                        <td style={{ width: "20%" }}>
                                                                            <div>
                                                                                {item.TeamLeaderUser.map(function (client1: { Title: string;
                                                                            }) {
                                                                                return (
                                                                                    <span className="ClientCategory-Usericon">
                                                                        ...
                                                                        <td style={{ width: "10%" }}>{item.Child.PercentComplete}</td>
                                                                        <td style={{ width: "10%" }}>{item.Child.ItemRank}</td>
                                                        ...
                                                        {item.show && (
                                                            <>
                                                                {item.Child.map(function (childitem: any) {
                                                                    if (secondSearch == "" || childitem.Title.toLowerCase().includes(secondSearch.toLowerCase())) {
                                                                        return (
